                ...
                <div class="row search-bar pb-3 pl-3">
                    <form class="form-inline my-2 my-lg-0" action="{{URL('datasiswa/cari')}}" method="GET">
                        ...
                        <div class="tambahdata pl-2">
                            <a href="{{URL('admin/viewinputsiswa')}}" class="btn btn-primary my-2 my-sm-0">Tambah Data Siswa</a> 
                        </div>
                </div> 
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="modal-siswa">
                                    ...
                                    &nbsp;
                                    <a href="admin/deletesiswa/{{$data->id}}" onclick="return confirm('You are going to delete {{$data->nama_siswa}} from the record. Are you sure?')"><button type="submit"
                                            class="btn btn-danger">Delete Data</button></a>
