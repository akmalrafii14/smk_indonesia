        ...
        <div class="card">
            <div class="card-body">
                ...
                <form method="POST" action="{{route('inputnilai')}}" id="formSiswa" class="pt-3">
                    ...
                    <div class="form-group row">
                        <label for="nis" class="col-md-4 col-form-label text-md-right">{{ __('Nomor Induk Pegawai') }}</label>
                        <div class="col-md-7">
                            <label for="nis" class="col-md-4 col-form-label">{{$dataguru->nip}}</label>

                            <input id="text" type="hidden" class="form-control" name="nip" value="{{$dataguru->nip}}" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-7">
                            ...
                            <input id="text" type="hidden" class="form-control" name="mapel" value="{{$dataguru->prodi}}" required>
                        </div>
                    </div>

                    <h3>Data Siswa</h3>
                    <div class="form-group row">
                        <label for="nis" class="col-md-4 col-form-label text-md-right">{{ __('Nomor Induk Siswa') }}</label>
                        <div class="col-md-7">
                    ...
                    <div class="form-group row">
                        <label for="nis" class="col-md-4 col-form-label text-md-right">{{ __('Nilai Ulangan Harian') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="nis" class="col-md-4 col-form-label text-md-right">{{ __('Nilai Ulangan Tengah Semester') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="nis" class="col-md-4 col-form-label text-md-right">{{ __('Nilai Akhir Semester') }}</label>
